...
linear_sot_object_life_params = [
    Object(
        initial=GaussianDensity(means=np.array([-750.0, -750.0, 75.0, 75.0]), covs=50 * np.eye(4)),
        t_birth=0,
        t_death=100,
    )
]
...
linear_n_mot_object_life_params = [
    Object(
        initial=GaussianDensity(means=np.array([0.0, 0.0, 0.0, -10.0]), covs=10 * np.eye(4)),
        t_birth=0,
        t_death=99,
    ),
    Object(
...
nonlinear_n_mot_object_life_params = [
    Object(
        initial=GaussianDensity(means=np.array([0.0, 0.0, 5.0, 0.0, np.pi / 180]), covs=default_nonlinear_P),
        t_birth=0,
        t_death=99,
    ),
    Object(
