...
class MeasurementData:
    ...
    def generate(self):
        ...
        return self.timestep, np.concatenate(measurements, axis=0), np.concatenate(sources, axis=0)
    ...
    def generate_observations(self):
        ...
        if len(objects_in_scene) > 0:
            ...
            observed_objects = [
                (obj_id, obj) for is_observed, (obj_id, obj) in zip(detection_mask, self.object_data[self.timestep].items()) if is_observed
            ]
