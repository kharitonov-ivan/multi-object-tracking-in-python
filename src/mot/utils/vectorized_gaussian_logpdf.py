...
def vectorized_gaussian_logpdf(
    data_points: NDArray[Shape["N_points, Point_dim"], Float],
    means: NDArray[Shape["N_gaussians, Point_dim"], Float],
    covariances: NDArray[Shape["N_gaussians, Point_dim, Point_dim"], Float],
) -> NDArray[Shape["N_points, N_gaussians"], Float]:
    """
