...
def test_ellipsoidal_gating_known_values():
    ...
    covs = np.array([[[2.0, 0.5, 0.1, 0.2], [0.5, 3.0, 0.1, 0.2], [0.1, 0.1, 2.0, 0.3], [0.2, 0.2, 0.3, 4.0]]])  # (1, 4, 4)
    ...
    assert np.all(mah_dists < chi2.ppf(confidence_level, df=measurement_model.d)), "All measurements should be outside the gate"
